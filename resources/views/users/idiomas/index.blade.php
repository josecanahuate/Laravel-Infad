                            ...
                            <td> <!-- Nueva celda para acciones -->
                                <div class="d-flex justify-content-center">
                                    ...
                                    <a class="btn btn-primary btn-sm mr-2"
                                        href="{{ route('users.idiomas.edit', $idioma) }}">EDITAR</a>
                                    {{-- @endcan --}}
                                    {{-- @can('.idiomas.destroy') --}}
                                    <form id="delete-form" action="{{ route('users.idiomas.destroy', $idioma) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="button" class="btn btn-danger btn-sm"
                                            onclick="confirmDelete()">BORRAR</button>
                                    </form>
                                    {{--  @endcan --}}
                                </div>
                            </td>
