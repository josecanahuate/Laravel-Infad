        ...
        <div class="row">        
            ...
            <div class="form-group col-lg-4 col-md-4 mb-3" data-select2-id="29">
                ...
                <div class="form-group col-lg-4 col-md-4 mb-3">
                    ...
                    <select class="form-control select2 area" id="id_area_investigacion" name="id_area_investigacion" style="width: 100%;" value="{{ old('id_area_investigacion') }}">
                        <option disabled selected>Seleccione una opción</option>
                        @foreach ($areas as $area)
                            <option value="{{ $area->id_areainv }}" {{ old('id_area_investigacion') == $area->id_areainv ? 'selected' : '' }}>{{ $area->nombreainvest }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group col-lg-4 col-md-4 mb-3">
                    ...
                    <select class="form-control select2" id="id_linea_investigacion" name="id_linea_investigacion" style="width: 100%;" value="{{ old('id_linea_investigacion') }}">
                        <option disabled selected>Seleccione una opción</option>
                        @foreach ($lineas as $linea)
                            <option value="{{ $linea->id_linea }}" {{ old('id_linea_investigacion') == $linea->id_linea ? 'selected' : '' }}>{{ $linea->nombre_linea }}</option>
                        @endforeach
                    </select>
