...
Route::middleware(['auth'])->group(function () {
    ...
    Route::resource('idiomas', IdiomaController::class)->names('users.idiomas');
    Route::delete('/users/idiomas/image/{id}', [IdiomaController::class, 'destroyImage'])->name('users.idiomas.image.destroy');
    ...
    Route::get('/lineas-investigacion/{areaId}', [ProyectoInscritoController::class, 'getLineasByArea']);
